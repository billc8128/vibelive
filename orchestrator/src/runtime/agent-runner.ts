...
import { NullModelClient, type AgentDecision, type ModelClient } from "./model-client.js";
import type { Persona } from "./personas.js";

export class AgentRunner {
  constructor(private readonly modelClient: ModelClient = new NullModelClient()) {}
